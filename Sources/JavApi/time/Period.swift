...
extension java.time.Period: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.Period, rhs: java.time.Period) -> Bool {
...
extension java.time.Period: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.Period: CustomReflectable {
