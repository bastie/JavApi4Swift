...
extension java.time {
  public struct ZonedDateTime {
    ...
    /// - Returns: The parsed zoned date-time.
    public static func parse(_ text: String, timeZone: Foundation.TimeZone) -> ZonedDateTime? {
    ...
    ///     - timeZone: The TimeZone instance.
    /// - Returns: The parsed zoned date-time.
    public static func parse(_ text: String, formatter: DateFormatter, timeZone: Foundation.TimeZone) -> ZonedDateTime? {
    ...
    public var timeZone: Foundation.TimeZone { return self.internalClock.toTimeZone() }
    ...
    public func toDate(timeZone: Foundation.TimeZone? = nil) -> Date {
    ...
    /// - Parameters zoneSameLocal: the time-zone to change to.
    /// - Returns: A ZonedDateTime based on this date-time with the requested zone.
    public func with(zoneSameLocal timeZone: Foundation.TimeZone) -> ZonedDateTime {
    ...
    /// - Parameters zoneSameLocal: the time-zone to change to.
    /// - Returns: A ZonedDateTime based on this date-time with the requested zone.
    public func with(zoneSameInstant timeZone: Foundation.TimeZone) -> ZonedDateTime {
    ...
    /// Creates the current date-time from the time-zone.
    public init(timeZone: Foundation.TimeZone) {
    ...
    /// Creates a ZonedDateTime from an instance of Date.
    public init(_ date: Date, timeZone: Foundation.TimeZone) {
    ...
    /// Creates an instance of ZonedDateTime from an instance of LocalDateTime.
    public init(_ dateTime: LocalDateTime, timeZone: Foundation.TimeZone) {
    ...
    /// Returns a copy of this date-time with the new date and time, checking
    /// to see if a new object is in fact required.
    public init(date: LocalDate, time: LocalTime, timeZone: Foundation.TimeZone) {
    ...
    /// Creates an instance of ZonedDateTime from year, month,
    /// day, hour, minute, second and nanosecond.
    public init(year: Int, month: Int, day: Int, hour: Int, minute: Int, second: Int, nanoOfSecond: Int, timeZone: Foundation.TimeZone) {
      self.init(
        year: year,
        month: month,
        day: day,
    ...
    /// Creates an instance of ZonedDateTime using seconds from the
    /// epoch of 1970-01-01T00:00:00Z.
    public init(epochDay: Int64, nanoOfDay: Int64, timeZone: Foundation.TimeZone) {
...
extension java.time.ZonedDateTime: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.ZonedDateTime, rhs: java.time.ZonedDateTime) -> Bool {
...
extension java.time.ZonedDateTime: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.ZonedDateTime: CustomReflectable {
...
extension java.time.ZonedDateTime: Codable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.internalDateTime = try container.decode(java.time.LocalDateTime.self, forKey: .datetime)
    self.internalClock = try container.decode(java.time.Clock.self, forKey: .clock)
  }
