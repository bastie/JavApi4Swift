...
extension java.time {
  public struct LocalDate {
    ...
    /// - Returns: The parsed local date.
    static public func parse(_ text: String, timeZone: Foundation.TimeZone = Foundation.TimeZone.current) -> LocalDate? {
...
extension java.time.LocalDate: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.LocalDate, rhs: java.time.LocalDate) -> Bool {
...
extension java.time.LocalDate: Hashable {
...
extension java.time.LocalDate: Equatable {
...
extension java.time.LocalDate: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.LocalDate: CustomReflectable {
...
extension java.time.LocalDate: CustomPlaygroundDisplayConvertible {
...
#if swift(>=3.2)
extension java.time.LocalDate: Codable {
