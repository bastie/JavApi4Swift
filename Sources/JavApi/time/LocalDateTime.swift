...
extension java.time {
  public struct LocalDateTime {
    ...
    /// - Returns: The parsed local date-time.
    static public func parse(_ text: String, timeZone: Foundation.TimeZone = Foundation.TimeZone.current) -> LocalDateTime? {
      /// ISO8601 format
...
//      }
    ...
    fileprivate var internalDate: java.time.LocalDate
    fileprivate var internalTime: java.time.LocalTime
    
    fileprivate mutating func normalize() {
      if self.internalTime.hour >= java.time.LocalTime.Constant.hoursPerDay {
        self.internalDate.day += (self.internalTime.hour / java.time.LocalTime.Constant.hoursPerDay)
        self.internalTime.hour %= java.time.LocalTime.Constant.hoursPerDay
      }
    }
    ...
    public func toDate(timeZone: Foundation.TimeZone = Foundation.TimeZone.current) -> Date {
    ...
    /// Creates the current date-time from the time-zone.
    public init(timeZone: Foundation.TimeZone = Foundation.TimeZone.current) {
      let now = Date()
    ...
    /// Creates a local date-time from an instance of Date.
    public init(_ date: Date, timeZone: Foundation.TimeZone = Foundation.TimeZone.current) {
      var calendar = Calendar.current
      calendar.timeZone = timeZone
...
extension java.time.LocalDateTime: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.LocalDateTime, rhs: java.time.LocalDateTime) -> Bool {
...
extension java.time.LocalDateTime: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.LocalDateTime: CustomReflectable {
...
extension java.time.LocalDateTime: Codable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.internalDate = try container.decode(java.time.LocalDate.self, forKey: .date)
    self.internalTime = try container.decode(java.time.LocalTime.self, forKey: .time)
  }
