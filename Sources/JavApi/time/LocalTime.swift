...
extension java.time {
  ...
  public struct LocalTime {
    ...
    /// - Returns: The parsed local time.
    static public func parse(_ text: String, timeZone: Foundation.TimeZone = Foundation.TimeZone.current) -> LocalTime? {
    ...
    static public func parse(_ text: String, formatter: DateFormatter, timeZone: Foundation.TimeZone = Foundation.TimeZone.current) -> LocalTime? {
      // LocalTime carries no timezone information — the numeric values in the
      ...
      return LocalTime(date, timeZone: utc)
    }
...
extension java.time.LocalTime: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.LocalTime, rhs: java.time.LocalTime) -> Bool {
...
extension java.time.LocalTime: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.LocalTime: CustomReflectable {
