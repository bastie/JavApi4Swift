  ...
  public struct Clock {
    ...
    public var offsetSecond: Int {
      if self.isAutoUpdatingFromCurrent {
        ...
        let newOffset = Foundation.TimeZone.current.secondsFromGMT()
    ...
    fileprivate var internalCurrentTimeZone = Foundation.TimeZone.current
    ...
    public func toTimeZone() -> Foundation.TimeZone {
      return Foundation.TimeZone(secondsFromGMT: offsetSecond)!
    }
    ...
    public init(identifier: ClockIdentifierName) {
      switch identifier {
      case .current:
        self.init(Foundation.TimeZone.current)
      ...
      default:
        self.init(Foundation.TimeZone(identifier: identifier.rawValue)!)
      }
    }
    ...
    public init?(identifier: String) {
      guard let timeZone = Foundation.TimeZone(identifier: identifier) else { return nil }
      self.init(timeZone)
    }
    
    /// Creates a time zone from an instance of TimeZone.
    public init(_ timeZone: Foundation.TimeZone = Foundation.TimeZone.current) {
...
extension java.time.Clock: Comparable {
  
  /// Returns a Boolean value indicating whether the value of the first
  /// argument is less than that of the second argument.
  public static func <(lhs: java.time.Clock, rhs: java.time.Clock) -> Bool {
...
extension java.time.Clock: Equatable {
...
extension java.time.Clock: CustomStringConvertible, CustomDebugStringConvertible {
...
extension java.time.Clock: CustomReflectable {
...
extension java.time.Clock: Codable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.internalCurrentTimeZone = Foundation.TimeZone(secondsFromGMT: seconds)!
  }
