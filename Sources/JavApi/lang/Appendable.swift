...
public protocol Appendable {
   ...
   */
  func append(_ c : Character) throws -> Appendable
   ...
   *             if an I/O error occurs.
   */
  func append(_ csq : any CharSequence) throws  -> Appendable
   ...
   *             if an I/O error occurs.
   */
  func append(_ csq : any CharSequence, _ start : Int, _ end : Int) throws -> Appendable
}
