...
class JavApi_time_LocalTime_Tests : XCTestCase {
  ...
  func testMinus() {
    ...
    let compareTime1 = java.time.LocalTime(hour: 13, minute: 2, second: 18, nanoOfSecond: 1573)
    let compareTime2 = java.time.LocalTime(hour: 14, minute: 1, second: 18, nanoOfSecond: 1573)
    let compareTime3 = java.time.LocalTime(hour: 14, minute: 2, second: 17, nanoOfSecond: 1573)
    let compareTime4 = java.time.LocalTime(hour: 14, minute: 2, second: 18, nanoOfSecond: 1572)
  ...
  func testPlus() {
    ...
    let compareTime1 = java.time.LocalTime(hour: 15, minute: 2, second: 18, nanoOfSecond: 1573)
    let compareTime2 = java.time.LocalTime(hour: 14, minute: 3, second: 18, nanoOfSecond: 1573)
    let compareTime3 = java.time.LocalTime(hour: 14, minute: 2, second: 19, nanoOfSecond: 1573)
    let compareTime4 = java.time.LocalTime(hour: 14, minute: 2, second: 18, nanoOfSecond: 1574)
  ...
  func testWith() {
    ...
    let compareTime1 = java.time.LocalTime(hour: 23, minute: 2, second: 18, nanoOfSecond: 1573)
    let compareTime2 = java.time.LocalTime(hour: 14, minute: 9, second: 18, nanoOfSecond: 1573)
    let compareTime3 = java.time.LocalTime(hour: 14, minute: 2, second: 59, nanoOfSecond: 1573)
    let compareTime4 = java.time.LocalTime(hour: 14, minute: 2, second: 18, nanoOfSecond: 123_157_234)
  ...
  func testHashable() {
    let date = java.time.LocalTime(hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
  ...
  func testCodable() {
    let date1 = java.time.LocalTime(hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let jsonString = String(data: try! JSONEncoder().encode(date1), encoding: .utf8)!
    
    let jsonData = jsonString.data(using: .utf8)!
    let date2 = try! JSONDecoder().decode(java.time.LocalTime.self, from: jsonData)
