...
class JavApi_time_LocalDateTime_Tests: XCTestCase {
  ...
  func testMinMaxRange() {
    let min = java.time.LocalDateTime.min
    let max = java.time.LocalDateTime.max
  ...
  func testComparable() {
    ...
    let oldDate = java.time.LocalDateTime(year: 1627, month: 2, day: 10, hour: 14, minute: 2, second: 18, nanoOfSecond: 1573)
    let newDate1 = java.time.LocalDateTime(year: 1627, month: 2, day: 10, hour: 14, minute: 2, second: 18, nanoOfSecond: 1574)
    let newDate2 = java.time.LocalDateTime(year: 1627, month: 2, day: 10, hour: 15, minute: 2, second: 18, nanoOfSecond: 1574)
    let equalDate = java.time.LocalDateTime(year: 1627, month: 2, day: 10, hour: 14, minute: 2, second: 18, nanoOfSecond: 1573)
    ...
    /// #15 TestCode
    let test1 = java.time.LocalDateTime(year: 1500, month: 6, day: 15, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    let test2 = java.time.LocalDateTime(year: 1499, month: 6, day: 15, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_001)
    let test3 = java.time.LocalDateTime(year: 1499, month: 6, day: 15, hour: 12, minute: 30, second: 31, nanoOfSecond: 500_000_000)
    let test4 = java.time.LocalDateTime(year: 1499, month: 6, day: 15, hour: 12, minute: 31, second: 30, nanoOfSecond: 500_000_000)
    let test5 = java.time.LocalDateTime(year: 1499, month: 6, day: 15, hour: 13, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    let test6 = java.time.LocalDateTime(year: 1499, month: 6, day: 16, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    let test7 = java.time.LocalDateTime(year: 1499, month: 7, day: 15, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    ...
    let test8 = java.time.LocalDateTime(year: 1501, month: 6, day: 15, hour: 12, minute: 30, second: 30, nanoOfSecond: 499_999_999)
    let test9 = java.time.LocalDateTime(year: 1501, month: 6, day: 15, hour: 12, minute: 30, second: 29, nanoOfSecond: 500_000_000)
    let test10 = java.time.LocalDateTime(year: 1501, month: 6, day: 15, hour: 12, minute: 29, second: 30, nanoOfSecond: 500_000_000)
    let test11 = java.time.LocalDateTime(year: 1501, month: 6, day: 15, hour: 11, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    let test12 = java.time.LocalDateTime(year: 1501, month: 6, day: 14, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_000)
    let test13 = java.time.LocalDateTime(year: 1501, month: 5, day: 15, hour: 12, minute: 30, second: 30, nanoOfSecond: 500_000_000)
  ...
  func testFixOverflow() {
    let date = java.time.LocalDateTime(year: 2000, month: 13, day: 32, hour: 14, minute: 61, second: 18, nanoOfSecond: 1573)
  ...
  func testFixUnderflow() {
    let date = java.time.LocalDateTime(year: 2000, month: 0, day: -30, hour: 14, minute: -2, second: 18, nanoOfSecond: 1573)
  ...
  func testFromEpochDayAndNanoOfDay() {
    let date = java.time.LocalDateTime(epochDay: -354285, nanoOfDay: 13_602_057_328_029)
  ...
  func testOtherTimeZone() {
    ...
    let localDate1 = java.time.LocalDateTime(clock: java.time.Clock.UTC)
    let localDate2 = java.time.LocalDateTime(date, clock: java.time.Clock.UTC)
  ...
  func testFormat() {
    let date = java.time.LocalDateTime(year: 2017, month: 7, day: 24, hour: 3, minute: 46, second: 42, nanoOfSecond: 57_328_029)
  ...
  func testUntil() {
    let oldDate = java.time.LocalDateTime(year: 1627, month: 2, day: 10, hour: 14, minute: 2, second: 18, nanoOfSecond: 1573)
    let newDate1 = java.time.LocalDateTime(year: 1628, month: 3, day: 12, hour: 15, minute: 3, second: 19, nanoOfSecond: 1574)
    ...
    let newDate2 = java.time.LocalDateTime(year: 1628, month: 3, day: 11, hour: 14, minute: 3, second: 19, nanoOfSecond: 1574)
    ...
    let newDate3 = java.time.LocalDateTime(year: 1628, month: 3, day: 13, hour: 14, minute: 3, second: 19, nanoOfSecond: 1574)
  ...
  func testRange() {
    let date = java.time.LocalDateTime(year: 1628, month: 3, day: 12, hour: 15, minute: 3, second: 19, nanoOfSecond: 1574)
  ...
  func testMinus() {
    let date = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    
    let compareDate1 = java.time.LocalDateTime(year: 1999, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate2 = java.time.LocalDateTime(year: 2000, month: 10, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate3 = java.time.LocalDateTime(year: 2000, month: 11, day: 29, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate4 = java.time.LocalDateTime(year: 2000, month: 11, day: 23, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate5 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 10, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate6 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 50, second: 18, nanoOfSecond: 1573)
    let compareDate7 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 17, nanoOfSecond: 1573)
    let compareDate8 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1572)
  ...
  func testPlus() {
    ...
    let compareDate1 = java.time.LocalDateTime(year: 2001, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate2 = java.time.LocalDateTime(year: 2000, month: 12, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate3 = java.time.LocalDateTime(year: 2000, month: 11, day: 31, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate4 = java.time.LocalDateTime(year: 2000, month: 12, day: 7, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate5 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 12, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate6 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 52, second: 18, nanoOfSecond: 1573)
    let compareDate7 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 19, nanoOfSecond: 1573)
    let compareDate8 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1574)
  ...
  func testWith() {
    ...
    let compareDate1 = java.time.LocalDateTime(year: 1, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate2 = java.time.LocalDateTime(year: 2000, month: 1, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate3 = java.time.LocalDateTime(year: 2000, month: 11, day: 1, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate4 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 1, minute: 51, second: 18, nanoOfSecond: 1573)
    let compareDate5 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 1, second: 18, nanoOfSecond: 1573)
    let compareDate6 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 1, nanoOfSecond: 1573)
    let compareDate7 = java.time.LocalDateTime(year: 2000, month: 11, day: 30, hour: 11, minute: 51, second: 18, nanoOfSecond: 1)
  ...
  func testLengthOfMonth() {
    let date = java.time.LocalDateTime(year: 1628, month: 2, day: 12, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    XCTAssertEqual(date.lengthOfMonth(), 29)
  }
  func testDayOfWeek() {
    /// This result of the test was refers Apple Calendar in macOS.
    
    let date1 = java.time.LocalDateTime(year: 1628, month: 3, day: 12, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
    XCTAssertEqual(date1.dayOfWeek, 6)
    
    let date2 = java.time.LocalDateTime(year: 1, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
    XCTAssertEqual(date2.dayOfWeek, 0)
    
    let date3 = java.time.LocalDateTime(year: 1970, month: 1, day: 1, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
    XCTAssertEqual(date3.dayOfWeek, 3)
    
    let date4 = java.time.LocalDateTime(year: 1969, month: 12, day: 31, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
    XCTAssertEqual(date4.dayOfWeek, 2)
    
    let date5 = java.time.LocalDateTime(year: 1517, month: 7, day: 18, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
    XCTAssertEqual(date5.dayOfWeek, 2)
    
    let date6 = java.time.LocalDateTime(year: -1, month: 12, day: 26, hour: 0, minute: 0, second: 0, nanoOfSecond: 0)
  ...
  func testAddDate() {
    var oldDate = java.time.LocalDateTime(year: 1000, month: 1, day: 1, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let addDate = java.time.LocalDateTime(year: 0, month: 1, day: 3, hour: 0, minute: 8, second: 0, nanoOfSecond: 0)
  ...
  func testSubtractDate() {
    var oldDate = java.time.LocalDateTime(year: 1000, month: 1, day: 7, hour: 11, minute: 51, second: 18, nanoOfSecond: 1573)
    let addDate = java.time.LocalDateTime(year: 0, month: 1, day: 3, hour: 0, minute: 8, second: 0, nanoOfSecond: 0)
    var newDate = oldDate - addDate
  ...
  func testToDate() {
    ...
    let localDate = java.time.LocalDateTime(year: 1999, month: 10, day: 31, hour: 11, minute: 51, second: 18, nanoOfSecond: 153_000_000)
  ...
  func testHashable() {
    let date = java.time.LocalDateTime(year: 1999, month: 10, day: 31, hour: 11, minute: 51, second: 18, nanoOfSecond: 153_000_000)
  ...
  func testCodable() {
    let date1 = java.time.LocalDateTime(year: 1999, month: 10, day: 31, hour: 11, minute: 51, second: 18, nanoOfSecond: 153_000_000)
    let jsonString = String(data: try! JSONEncoder().encode(date1), encoding: .utf8)!
    
    let jsonData = jsonString.data(using: .utf8)!
    let date2 = try! JSONDecoder().decode(java.time.LocalDateTime.self, from: jsonData)
